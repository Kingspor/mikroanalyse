...
var require_msal_browser = __commonJS({
  "node_modules/@azure/msal-browser/lib/msal-browser.js"(exports, module) {
    (function(global, factory) {
      ...
      const IntFields = /* @__PURE__ */ new Set([
        "accessTokenSize",
        "durationMs",
        "idTokenSize",
        "matsSilentStatus",
      ...
      function generateAppMetadataKey({ environment, clientId }) {
        ...
        return appMetaDataKeyArray.join(CACHE_KEY_SEPARATOR$1).toLowerCase();
      }
      ...
      class ServerTelemetryManager {
        constructor(telemetryRequest, cacheManager) {
          ...
          this.telemetryCacheKey = SERVER_TELEM_CACHE_KEY + CACHE_KEY_SEPARATOR$1 + telemetryRequest.clientId;
        }
        /**
      ...
      const AwaitConcurrentIframe = "awaitConcurrentIframe";
      ...
      exports2.InteractionType = void 0;
      (function(InteractionType) {
        InteractionType["Redirect"] = "redirect";
        InteractionType["Popup"] = "popup";
        InteractionType["Silent"] = "silent";
        InteractionType["None"] = "none";
      })(exports2.InteractionType || (exports2.InteractionType = {}));
      ...
      function isInPopup() {
        ...
        try {
          ...
          return meta["interactionType"] === exports2.InteractionType.Popup;
        } catch (e) {
          return false;
        }
      }
      ...
      class PlatformAuthInteractionClient extends BaseInteractionClient {
        ...
        async cacheNativeTokens(response, request, homeAccountIdentifier, idTokenClaims, tenantId, reqTimestamp, environment) {
          ...
          const expiresIn = request.tokenType === AuthenticationScheme$1.POP ? SHR_NONCE_VALIDITY : (typeof response.expires_in === "string" ? parseInt(response.expires_in, 10) : response.expires_in) || 0;
          const tokenExpirationSeconds = reqTimestamp + expiresIn;
        ...
        getExpiresInValue(tokenType, expiresIn) {
          return tokenType === AuthenticationScheme$1.POP ? SHR_NONCE_VALIDITY : (typeof expiresIn === "string" ? parseInt(expiresIn, 10) : expiresIn) || 0;
        }
      ...
      class PopupClient extends StandardInteractionClient {
        ...
        async executeCodeFlow(request, popupParams, pkceCodes) {
          ...
          try {
            ...
            if (popupRequest.httpMethod === HttpMethod.POST) {
              ...
              this.eventHandler.emitEvent(EventType.POPUP_OPENED, correlationId, exports2.InteractionType.Popup, { popupWindow }, null);
        ...
        async logoutPopupAsync(validRequest, popupParams, requestAuthority, mainWindowRedirectUri) {
          ...
          this.eventHandler.emitEvent(EventType.LOGOUT_START, this.correlationId, exports2.InteractionType.Popup, validRequest);
          ...
          try {
            ...
            try {
              ...
              if (validRequest.account?.homeAccountId && validRequest.postLogoutRedirectUri && authClient.authority.protocolMode === ProtocolMode.OIDC) {
                this.eventHandler.emitEvent(EventType.LOGOUT_SUCCESS, validRequest.correlationId, exports2.InteractionType.Popup, validRequest);
            ...
            validRequest.state = setRequestState(this.browserCrypto, validRequest.state || "", {
              interactionType: exports2.InteractionType.Popup
            });
            const logoutUri = authClient.getLogoutUri(validRequest);
            this.eventHandler.emitEvent(EventType.LOGOUT_SUCCESS, validRequest.correlationId, exports2.InteractionType.Popup, validRequest);
            const popupWindow = this.openPopup(logoutUri, popupParams);
            this.eventHandler.emitEvent(EventType.POPUP_OPENED, validRequest.correlationId, exports2.InteractionType.Popup, { popupWindow }, null);
            ...
            this.eventHandler.emitEvent(EventType.LOGOUT_FAILURE, this.correlationId, exports2.InteractionType.Popup, null, e);
            this.eventHandler.emitEvent(EventType.LOGOUT_END, this.correlationId, exports2.InteractionType.Popup);
            throw e;
          }
          this.eventHandler.emitEvent(EventType.LOGOUT_END, this.correlationId, exports2.InteractionType.Popup);
        }
      ...
      class RedirectClient extends StandardInteractionClient {
        ...
        async acquireToken(request) {
          const validRequest = await invokeAsync(initializeAuthorizationRequest, StandardInteractionClientInitializeAuthorizationRequest, this.logger, this.performanceClient, this.correlationId)(request, exports2.InteractionType.Redirect, this.config, this.browserCrypto, this.browserStorage, this.logger, this.performanceClient, this.correlationId);
          ...
          const handleBackButton = (event) => {
            if (event.persisted) {
              ...
              this.eventHandler.emitEvent(EventType.RESTORE_FROM_BFCACHE, this.correlationId, exports2.InteractionType.Redirect);
            }
          };
        ...
        getRedirectResponse(userProvidedResponse) {
          ...
          if (!responseString) {
            if (this.config.auth.OIDCOptions.responseMode === ResponseMode$1.QUERY) {
          ...
          if (response) {
            try {
              validateInteractionType(response, this.browserCrypto, exports2.InteractionType.Redirect);
            } catch (e) {
              if (e instanceof AuthError) {
        ...
        async logout(logoutRequest) {
          ...
          try {
            this.eventHandler.emitEvent(EventType.LOGOUT_START, this.correlationId, exports2.InteractionType.Redirect, logoutRequest);
            ...
            if (authClient.authority.protocolMode === ProtocolMode.OIDC) {
              try {
                ...
                if (validLogoutRequest.account?.homeAccountId) {
                  this.eventHandler.emitEvent(EventType.LOGOUT_SUCCESS, this.correlationId, exports2.InteractionType.Redirect, validLogoutRequest);
                  return;
                }
              }
            }
            validLogoutRequest.state = setRequestState(this.browserCrypto, validLogoutRequest.state || "", {
              interactionType: exports2.InteractionType.Redirect
            });
            ...
            this.eventHandler.emitEvent(EventType.LOGOUT_FAILURE, this.correlationId, exports2.InteractionType.Redirect, null, e);
            this.eventHandler.emitEvent(EventType.LOGOUT_END, this.correlationId, exports2.InteractionType.Redirect);
            throw e;
          }
          this.eventHandler.emitEvent(EventType.LOGOUT_END, this.correlationId, exports2.InteractionType.Redirect);
        }
      ...
      class SilentAuthCodeClient extends StandardInteractionClient {
        ...
        async acquireToken(request) {
          ...
          const silentRequest = await invokeAsync(initializeAuthorizationRequest, StandardInteractionClientInitializeAuthorizationRequest, this.logger, this.performanceClient, this.correlationId)(
            request,
            exports2.InteractionType.Silent,
            this.config,
            this.browserCrypto,
            this.browserStorage,
            this.logger,
      ...
      class StandardController {
        ...
        async handleRedirectPromiseInternal(options) {
          ...
          try {
            if (useNative && this.platformAuthProvider) {
              ...
              this.eventHandler.emitEvent(EventType.HANDLE_REDIRECT_START, correlationId, exports2.InteractionType.Redirect);
          ...
          return redirectResponse.then((result) => {
            if (result) {
              ...
              this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_SUCCESS, result.correlationId, exports2.InteractionType.Redirect, result);
              this.logger.verbose("0ui8f5", result.correlationId);
              const isLoggingIn = loggedInAccounts.length < this.getAllAccounts().length;
              if (isLoggingIn) {
                this.eventHandler.emitEvent(EventType.LOGIN_SUCCESS, result.correlationId, exports2.InteractionType.Redirect, result.account);
                this.logger.verbose("16im3l", result.correlationId);
              }
              rootMeasurement.end({
                success: true
              }, void 0, result.account);
              this.verifySsoCapability(cachedRedirectRequest, exports2.InteractionType.Redirect);
            } else {
            ...
            this.eventHandler.emitEvent(EventType.HANDLE_REDIRECT_END, rootMeasurement.event.correlationId, exports2.InteractionType.Redirect);
            return result;
          }).catch((e) => {
            this.browserStorage.resetRequestCache(rootMeasurement.event.correlationId);
            const eventError = e;
            this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_FAILURE, rootMeasurement.event.correlationId, exports2.InteractionType.Redirect, null, eventError);
            this.eventHandler.emitEvent(EventType.HANDLE_REDIRECT_END, rootMeasurement.event.correlationId, exports2.InteractionType.Redirect);
            rootMeasurement.end({
              success: false
            }, eventError);
        ...
        async acquireTokenRedirect(request) {
          ...
          try {
            ...
            this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_START, correlationId, exports2.InteractionType.Redirect, request);
            let result;
            ...
            this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_FAILURE, correlationId, exports2.InteractionType.Redirect, null, e);
            throw e;
          }
        }
        // #endregion
        ...
        acquireTokenPopup(request) {
          ...
          const loggedInAccounts = this.getAllAccounts();
          this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_START, correlationId, exports2.InteractionType.Popup, request);
          let result;
          ...
          return result.then((result2) => {
            const isLoggingIn = loggedInAccounts.length < this.getAllAccounts().length;
            this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_SUCCESS, correlationId, exports2.InteractionType.Popup, result2);
            if (isLoggingIn) {
              this.eventHandler.emitEvent(EventType.LOGIN_SUCCESS, correlationId, exports2.InteractionType.Popup, result2.account);
            }
            atPopupMeasurement.end({
              success: true,
            ...
            this.verifySsoCapability(request, exports2.InteractionType.Popup);
            return result2;
          }).catch((e) => {
            this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_FAILURE, correlationId, exports2.InteractionType.Popup, null, e);
            atPopupMeasurement.end({
              success: false
            }, e, request.account);
            return Promise.reject(e);
        ...
        async ssoSilent(request) {
          ...
          this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_START, correlationId, exports2.InteractionType.Silent, validRequest);
          let result;
          ...
          return result.then((response) => {
            const isLoggingIn = loggedInAccounts.length < this.getAllAccounts().length;
            this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_SUCCESS, correlationId, exports2.InteractionType.Silent, response);
            if (isLoggingIn) {
              this.eventHandler.emitEvent(EventType.LOGIN_SUCCESS, correlationId, exports2.InteractionType.Silent, response.account);
            }
            ...
            this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_FAILURE, correlationId, exports2.InteractionType.Silent, null, e);
            this.ssoSilentMeasurement?.end({
              success: false
            }, e, request.account);
            throw e;
        ...
        async acquireTokenByCode(request) {
          ...
          this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_START, correlationId, exports2.InteractionType.Silent, request);
            ...
            if (request.code && request.nativeAccountId) {
              ...
              if (!response) {
                ...
                response = this.acquireTokenByCodeAsync({
                  ...
                  this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_SUCCESS, correlationId, exports2.InteractionType.Silent, result);
                  ...
                  this.hybridAuthCodeResponses.delete(hybridAuthCode);
                  this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_FAILURE, correlationId, exports2.InteractionType.Silent, null, error);
                  atbcMeasurement.end({
                    success: false
                  }, error);
                  throw error;
        ...
        async acquireTokenSilentAsync(request, account) {
          ...
          this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_START, request.correlationId, exports2.InteractionType.Silent, request);
          if (request.correlationId) {
          ...
          return result.then((response) => {
            this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_SUCCESS, request.correlationId, exports2.InteractionType.Silent, response);
            if (request.correlationId) {
              this.performanceClient.addFields({
                fromCache: response.fromCache,
                isNativeBroker: response.fromPlatformBroker
            ...
            this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_FAILURE, request.correlationId, exports2.InteractionType.Silent, null, tokenRenewalError);
            throw tokenRenewalError;
          }).finally(() => {
        ...
        async acquireTokenSilentNoIframe(silentRequest, cacheLookupPolicy) {
          if (isPlatformAuthAllowed(this.config, this.logger, silentRequest.correlationId, this.platformAuthProvider, silentRequest.authenticationScheme) && silentRequest.account.nativeAccountId) {
            ...
            return invokeAsync(this.acquireTokenFromCache.bind(this), AcquireTokenFromCache, this.logger, this.performanceClient, silentRequest.correlationId)(silentRequest, cacheLookupPolicy).catch((cacheError) => {
              ...
              this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_NETWORK_START, silentRequest.correlationId, exports2.InteractionType.Silent, silentRequest);
      ...
      class BaseOperatingContext {
        static loggerCallback(level, message) {
          switch (level) {
            case exports2.LogLevel.Error:
              ...
              return;
            case exports2.LogLevel.Info:
              console.info(message);
              return;
            case exports2.LogLevel.Verbose:
        ...
        constructor(config) {
          ...
          const logLevel = logLevelKey && Object.keys(exports2.LogLevel).includes(logLevelKey) ? exports2.LogLevel[logLevelKey] : void 0;
          if (logLevel) {
      ...
      class NestedAppAuthController {
        ...
        async acquireTokenInteractive(request) {
          ...
          this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_START, correlationId, exports2.InteractionType.Popup, validRequest);
          const atPopupMeasurement = this.performanceClient.startMeasurement(AcquireTokenPopup, correlationId);
          ...
          try {
            ...
            this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_SUCCESS, correlationId, exports2.InteractionType.Popup, result);
            atPopupMeasurement.add({
              accessTokenSize: result.accessToken.length,
              idTokenSize: result.idToken.length
            });
        ...
        async acquireTokenSilentInternal(request) {
          ...
          try {
            ...
            this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_SUCCESS, correlationId, exports2.InteractionType.Silent, result2);
            ssoSilentMeasurement?.add({
              accessTokenSize: result2.accessToken.length,
              idTokenSize: result2.idToken.length
            });
        ...
        async acquireTokenFromCache(request) {
          ...
          this.eventHandler.emitEvent(EventType.ACQUIRE_TOKEN_FAILURE, correlationId, exports2.InteractionType.Silent, null);
          atsMeasurement.end({
            success: false
        ...
        static getInteractionStatusFromEvent(message, currentStatus) {
          switch (message.eventType) {
            case EventType.ACQUIRE_TOKEN_START:
              if (message.interactionType === exports2.InteractionType.Redirect || message.interactionType === exports2.InteractionType.Popup) {
      ...
      class BrowserPerformanceMeasurement {
        constructor(name2, correlationId) {
          this.correlationId = correlationId;
          this.measureName = BrowserPerformanceMeasurement.makeMeasureName(name2, correlationId);
          this.startMark = BrowserPerformanceMeasurement.makeStartMark(name2, correlationId);
          this.endMark = BrowserPerformanceMeasurement.makeEndMark(name2, correlationId);
        }
      ...
      exports2.BrowserAuthError = BrowserAuthError;
      exports2.BrowserAuthErrorCodes = BrowserAuthErrorCodes;
      exports2.BrowserCacheLocation = BrowserCacheLocation;
      exports2.BrowserConfigurationAuthError = BrowserConfigurationAuthError;
      exports2.BrowserConfigurationAuthErrorCodes = BrowserConfigurationAuthErrorCodes;
      exports2.BrowserPerformanceClient = BrowserPerformanceClient;
      exports2.BrowserPerformanceMeasurement = BrowserPerformanceMeasurement;
      exports2.BrowserRootPerformanceEvents = BrowserRootPerformanceEvents;
      exports2.BrowserUtils = BrowserUtils;
      exports2.CacheLookupPolicy = CacheLookupPolicy;
      ...
      exports2.DEFAULT_IFRAME_TIMEOUT_MS = DEFAULT_IFRAME_TIMEOUT_MS;
      exports2.EventHandler = EventHandler;
      exports2.EventMessageUtils = EventMessageUtils;
      ...
      exports2.InteractionStatus = InteractionStatus;
      ...
      exports2.SessionStorage = SessionStorage;
      exports2.SignedHttpRequest = SignedHttpRequest;
      exports2.StubPerformanceClient = StubPerformanceClient;
      exports2.WrapperSKU = WrapperSKU;
      exports2.createNestablePublicClientApplication = createNestablePublicClientApplication;
      exports2.createStandardPublicClientApplication = createStandardPublicClientApplication;
      exports2.enforceResourceParameter = enforceResourceParameter;
      exports2.isPlatformBrokerAvailable = isPlatformBrokerAvailable;
      exports2.loadExternalTokens = loadExternalTokens;
      exports2.stubbedPublicClientApplication = stubbedPublicClientApplication;
      exports2.version = version;
    }));
  }
});
export default require_msal_browser();
/*! Bundled license information:

@azure/msal-browser/lib/msal-browser.js:
